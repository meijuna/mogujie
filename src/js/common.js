...
function crash(small, big) {
    ...
    if (
        boxsmallL + boxsmallW >= boxbigL &&
        boxbigL + boxbigW >= boxsmallL &&
        boxsmallT + boxsmallH > boxbigT &&
        boxbigT + boxbigH >= boxsmallT
    ) {
        return true;
    } else {
        return false;
...
function playmove(Odiv, Movespend, Shellspend) {
    //div 移动发射子弹
    var Box = $id(Odiv);
    document.onkeydown = function(e) {
        ...
        if (code == 83 || code == 40) {
            ...
            function shellT() {
                ...
                shell.style.left =
                    shepX + Box.offsetWidth / 2 - shell.offsetWidth / 2 + "px";
            ...
            function shellR() {
                ...
                shell.style.top =
                    shepT + Box.offsetHeight / 2 - shell.offsetHeight / 2 + "px";
                setInterval(function() {
